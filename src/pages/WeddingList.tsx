        ...
        <div className="container max-w-3xl">
          ...
          {isLoading ? (
            ...
            <div className="space-y-6">
              {lists.map((list: WeddingListRecord) => {
                const items = list.wedding_list_items ?? [];
                const booked = items.filter((i: WeddingListItem) => i.status === "booked").length;
                      ...
                      <CardContent className="p-5 space-y-4">
                        ...
                        {items.length > 0 ? (
                          <div className="space-y-2">
                            {items.map((item: WeddingListItem) => {
