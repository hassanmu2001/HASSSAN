...
AS $function$
BEGIN
  INSERT INTO public.profiles (user_id, full_name, user_type, phone, city, country_code, date_of_birth, national_id, id_photo_url, business_name, business_address, commercial_register_url)
  VALUES (
    NEW.id,
    ...
    COALESCE(NEW.raw_user_meta_data->>'country_code', 'JO'),
